...
const { checkDeviceReachability, describeSignalFailure } = require("../../services/camaraClient");
      ...
      reasoningTrace: [
        {
          ...
          detail: `Device Reachability check unavailable (${describeSignalFailure(result.error)}) — treated as inconclusive, not a red flag.`,
